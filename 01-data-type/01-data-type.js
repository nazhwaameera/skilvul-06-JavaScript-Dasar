...
console.log(isNaN(isNotNumber) + ", isNotNumber tidak dapat dikategorikan sebagai number")
...
console.log(Number(stringToNumber) + ", Tipe data dari variabel berikut adalah " + typeof stringToNumber)